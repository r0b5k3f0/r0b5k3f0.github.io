...
- `/tools/pdf-toolbox/` — local browser PDF toolbox for merge, extract, split, rotate, images-to-PDF, and text extraction.
...
The PDF Toolbox vendors browser-side PDF libraries under `/tools/pdf-toolbox/vendor/`:
